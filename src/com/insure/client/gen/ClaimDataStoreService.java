 ...
 * 
 */
@WebServiceClient(name = "ClaimDataStoreService", targetNamespace = "http://server.insure.com/", wsdlLocation = "http://localhost:8091/docstorage?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8091/docstorage?wsdl");
